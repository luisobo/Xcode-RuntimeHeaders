...
- (id)ib_cachedObjectForKey:(id)arg1 fromInstantiator:(id)arg2;
...
- (id)ib_objectForKey:(id)arg1 inDictionaryForKey:(id)arg2 creatingIfNecessary:(id)arg3;
- (id)ib_objectForKey:(id)arg1 creatingIfNecessary:(id)arg2;
