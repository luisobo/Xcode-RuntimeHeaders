...
- (void)enumerateItemsFromParentToRoot:(id)arg1;
...
- (id)rootItem;
- (void)recursivelyNotifyAboutDidChange:(id)arg1;
...
- (void)mutateAndNotifyObserversAboutChangesToKey:(id)arg1 oldValue:(id)arg2 newValue:(id)arg3 mutator:(id)arg4;
