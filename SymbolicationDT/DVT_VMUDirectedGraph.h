...
- (void)breadthFirstSearch:(unsigned int)arg1 nodeVisitBlock:(id)arg2 edgeVisitBlock:(void)arg3;
- (void)depthFirstSearch:(unsigned int)arg1 nodeVisitBlock:(id)arg2 edgeVisitBlock:(void)arg3;
- (void)_searchMainLoop:(unsigned int)arg1 action:(id)arg2;
- (void)_bfsCore:(unsigned int)arg1 colors:(unsigned char *)arg2 nodeBlock:(id)arg3 edgeBlock:(void)arg4;
- (void)_dfsCore:(unsigned int)arg1 colors:(unsigned char *)arg2 nodeBlock:(id)arg3 edgeBlock:(void)arg4;
