...
@class DVTNotificationToken, DVTObservingToken, DVTReplacementView, DVTStackView_ML, IDEBotEditorArchivesViewController, IDEBotEditorBannerViewController, IDEBotEditorIntegrationHistoryViewController, IDEBotEditorSectionDividerView, IDEBotIssueSummaryViewController, IDEBotSupportingEditor, IDEStackedBarChartBar, IDEStackedBarChartViewController, IDEStatusAndIssueCountsViewController, NSArray, NSImageView, NSPopover, NSScrollView, NSString, NSTextField;
