...
@class DVTBindingToken, DVTLozengeTextField, DVTReplacementView, IDEBotSupportingEditor, IDESourceControlWorkingTree, NSArray, NSMutableArray, NSString, NSView;
