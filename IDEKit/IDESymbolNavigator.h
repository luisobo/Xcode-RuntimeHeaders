...
@class DVTDispatchLock, DVTObservingToken, DVTPerformanceMetric, DVTSDK, DVTScopeBarView, DVTSourceExpression, DVTSourceLanguageService, DVTStackBacktrace, IDENavigatorOutlineView, NSArray, NSCell, NSDictionary, NSMutableSet, NSSet, NSString, NSTableColumn;
