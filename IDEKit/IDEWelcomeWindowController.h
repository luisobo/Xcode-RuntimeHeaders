...
@class DVTNotificationToken, DVTObservingToken, DVTRolloverImageButton, DVTTableView, IDEFirstLaunchExperienceViewController, IDEInfiniteLineBox, IDEWelcomeFadeView, IDEWelcomePocketView, IDEWelcomeWindowHighlightButton, NSArrayController, NSImageView, NSMutableArray, NSScrollView, NSString, NSTableColumn, NSTextField, NSView;
