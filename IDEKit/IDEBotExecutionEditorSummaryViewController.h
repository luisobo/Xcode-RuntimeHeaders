...
@class DVTObservingToken, DVTReplacementView, DVTStackView_ML, IDEBotEditorArchivesViewController, IDEBotEditorBannerViewController, IDEBotIssueSummaryViewController, IDEBotSupportingEditor, IDEStatusAndIssueCountsViewController, NSArray, NSButton, NSScrollView, NSString, NSTextField, NSView;
