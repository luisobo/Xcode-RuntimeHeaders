...
+ (id)parametersForIdentity:(id)arg1 profileUUID:(id)arg2 andBundleIdentifier:(id)arg3 destinationDevice:(id)arg4 withError:(id *)arg5;
+ (id)parametersForIdentity:(id)arg1 profileUUID:(id)arg2 andBundleIdentifier:(id)arg3 requiringProfile:(_Bool)arg4 limitSearchToKeychain:(struct OpaqueSecKeychainRef *)arg5 destinationDevice:(id)arg6 withError:(id *)arg7;
+ (id)parametersForIdentity:(id)arg1 profileUUID:(id)arg2 andBundleIdentifier:(id)arg3 requiringProfile:(_Bool)arg4 destinationDevice:(id)arg5 withError:(id *)arg6;
