...
+ (id)sparseInfoByTransformingObjectsInSparseInfo:(id)arg1 usingBlock:(id)arg2;
...
- (id)sparseInfoOfClass:(Class)arg1 byTransformingObjectsUsingBlock:(id)arg2;
- (id)sparseInfoByTransformingObjectsUsingBlock:(id)arg1;
