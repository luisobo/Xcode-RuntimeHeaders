...
@property(copy, nonatomic) id subscribeCallback; // @synthesize subscribeCallback=_subscribeCallback;
- (void).cxx_destruct;
...
- (void)_resetName;
- (void)unsubscribe;
- (void)subscribeWithCompletionBlock:(id)arg1;
...
- (id)_loadFeedDataFromURL:(id)arg1 error:(id *)arg2 completionHandler:(id)arg3;
