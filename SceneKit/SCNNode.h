...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, SCNCamera, SCNGeometry, SCNLight, SCNMorpher, SCNPhysicsBody, SCNPhysicsField, SCNSkinner;
...
- (id)childNodesPassingTest:(id)arg1 recursively:(void)arg2;
- (BOOL)_childNodesPassingTest:(id)arg1 recursively:(void)arg2 output:(BOOL)arg3;
