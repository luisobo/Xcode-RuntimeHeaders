...
@interface DSMDocSetLoader : NSObject
{
    ...
    id _findAndLoadDocSetsInPathsBlock;
    ...
    id _docSetLoadingCompletionBlock;
...
@property(readonly) NSArray *recordsForEnabledDocSets;
- (void)loadDocSetsWithCompletionBlock:(id)arg1;
@property(readonly) NSArray *docSetLocations;
...
- (void)resolveURL:(id)arg1 completionBlock:(id)arg2;
...
- (void)findAndLoadDocSetsInPaths:(id)arg1 completionBlock:(id)arg2;
...
@property(readonly) NSArray *enabledDocSetRecords;
