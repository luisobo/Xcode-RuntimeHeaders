...
- (id)initMaxWidth:(unsigned long long)arg1 lookupFailedValue:(const void *)arg2 keepUnique:(BOOL)arg3 comparisonFunction:(void *)arg4 comparisonContext:(const void *)arg5;
