...
- (void).cxx_destruct;
- (void)cleanup;
- (void)registerRemotelyToServer:(id)arg1 port:(long long)arg2 asUser:(id)arg3 withPassword:(id)arg4 andHandler:(id)arg5;
- (void)registerLocallyWithHandler:(id)arg1;
- (BOOL)isRegistered;
- (void)dealloc;
