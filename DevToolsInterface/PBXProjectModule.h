...
+ (id)lastActiveType:(Class)arg1 inContextOfModule:(id)arg2 matchingFunction:(void *)arg3 usingData:(void *)arg4 lookBeyondContext:(BOOL)arg5;
+ (id)lastActiveType:(Class)arg1 inContextOfModule:(id)arg2 lookBeyondContext:(BOOL)arg3;
+ (void)initialize;
- (id)lastActiveType:(Class)arg1 matchingFunction:(void *)arg2 usingData:(void *)arg3;
