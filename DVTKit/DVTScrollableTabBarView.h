...
@class CALayer, DVTScrollableTabBarViewAnimation, DVTScrollableTabBarViewButton, DVTScrollableTabButton, NSMutableArray, NSScrollView, NSString, NSTrackingArea, NSView;
