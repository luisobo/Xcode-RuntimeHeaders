...
@class DVTMapTable, DVTStackBacktrace, IDEActivityLogSection, IDEBreakpointManager, IDEBuildOperation, IDEExecutionTracker, IDELaunchSession, IDELogStore, IDEWorkspaceArena, NSArray, NSCountedSet, NSMutableArray, NSMutableSet, NSOperationQueue, NSSet;
