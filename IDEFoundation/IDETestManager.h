...
@class DVTMapTable, DVTNotificationToken, DVTStackBacktrace, IDELogStore, IDEUnitTestsOperationsObserver, IDEWorkspace, NSArray, NSCountedSet, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet;
