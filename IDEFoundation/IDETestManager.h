...
- (void).cxx_destruct;
- (void)asyncApplyBaselineRecord:(id)arg1 forRunDestinationRecord:(id)arg2 withCompletionBlock:(id)arg3;
- (void)asyncApplyBaselineRecord:(id)arg1 forTestBundleRunDestinationRecord:(id)arg2 withCompletionBlock:(id)arg3;
