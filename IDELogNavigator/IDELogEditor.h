...
#import "IDEBuildResultsOutlineDelegate-Protocol.h"
#import "IDELogEditorScopeBarDelegate-Protocol.h"

@class IDEActivityLogSection, IDEBuildResultsOutlineLogic, IDELogEditorScopeBar, NSArray, NSBox, NSIndexPath, NSPopUpButton, NSView, XCBuildResultsOutlineView;

@interface IDELogEditor : IDEEditor <IDEBuildResultsOutlineDelegate, IDELogEditorScopeBarDelegate, DVTFindBarFindable>
{
